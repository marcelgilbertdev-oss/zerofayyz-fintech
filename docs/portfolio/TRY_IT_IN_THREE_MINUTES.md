...
| **Testing** | 269 automated tests across seven suites — unit, integration against real PostgreSQL, component suites for the Vue and Svelte clients, and end-to-end against a production build — plus a 28-check smoke suite that verifies the live deployment from outside |
