...
| **Testing** | 223 automated tests across five suites — unit, integration against real PostgreSQL, component suites for the Vue and Svelte clients, and end-to-end against a production build — plus a 26-check smoke suite that verifies the live deployment from outside |
