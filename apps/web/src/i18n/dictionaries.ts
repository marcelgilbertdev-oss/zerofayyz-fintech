...
const en = {
  ...
  auth: {
    ...
    magicAction: "Email me a sign-in link instead",
    magicSending: "Sending…",
    magicSent: "If that address has an account, a link is on its way",
    magicNeedEmail: "Enter your email above first",
    magicInvalid: "That sign-in link was invalid or expired — request a fresh one",
...
const ja: Dictionary = {
  ...
  auth: {
    ...
    magicAction: "サインインリンクをメールで受け取る",
    magicSending: "送信中…",
    magicSent: "そのアドレスにアカウントがあれば、リンクをお送りしました",
    magicNeedEmail: "先に上のメールアドレスを入力してください",
    magicInvalid: "サインインリンクが無効か期限切れです。新しいリンクを請求してください",
